...
export default function Footer() {
  ...
  return (
    <>
      <hr className="text-light" style={{ marginTop: "2%" }}></hr>
      <div className="container text-white" style={{ marginTop: "2%" }}>
        <div className="row">
          ...
          <div className="col-12">
            <div className="row">
              <div className="col-12 col-md-6" style={{ marginTop: "2%" }}>
                ...
                without any distractions. QuizMania is not just a platform; it's
                a gateway to endless knowledge and entertainment. With regular
                updates and new quizzes added, QuizMania offers an ever-evolving
                playground for knowledge enthusiasts.
              </div>
            </div>
          </div>
          ...
          <div style={{ marginTop: "1.5%", marginBottom: "1%" }}>
            <span class="text-light">&copy;2024 QuizMania</span>
          </div>
        </div>
      </div>
    </>
